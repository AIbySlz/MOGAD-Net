...
if __name__ == '__main__':
    ...
    fold_path_brain = r'D:\DATA\fold_partition\brain\5fold\42'
    split = "train"
    fold_index = 1

    dataset_brain = GeneralDataset_brain(feats_path, fold_path_brain, fold_index, split)
    dataloader_brain = DataLoader(dataset_brain, batch_size=16, shuffle=True, num_workers=2)
